...
?>
<form action="<?php echo JRoute::_('index.php?option=com_administrations&view=employees'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th width="40%">
					<?php echo JHtml::_('grid.sort', 'COM_ADMINISTRATIONS_HEADING_FUNC', 'a.nome', $listDirn, $listOrder); ?>
				</th>
			...
			<tr class="row<?php echo $i % 2; ?>">
				<td class="center">
					<?php echo JHtml::_('grid.id', $i, $item->id); ?>
                                ...
                                <td class="center">
                                    <a href="<?php echo JRoute::_('index.php?option=com_administrations&task=employee.edit&id='.(int) $item->id); ?>">
					<?php echo $item->nome; ?></a>
				</td>
                                <td class="center">
					<?php echo JHtml::_('jgrid.published', $item->published, $i, 'employees.', $canChange);?>
				</td>
                                <td class="center">
