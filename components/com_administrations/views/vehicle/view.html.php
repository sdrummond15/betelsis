...
class AdministrationsViewVehicle extends JView
{
    protected $form;
    protected $item;
    protected $state;
    ...
    protected function addToolbar()
    {
        ...
        JToolBarHelper::title($isNew ? JText::_('COM_ADMINISTRATIONS_VEHICLE_ADD') : JText::_('COM_ADMINISTRATIONS_VEHICLE_EDIT'), 'vehicles.png');
		...
		JToolBarHelper::help('JHELP_COMPONENTS_ADMINISTRATIONS_VEHICLES_EDIT');
	}
}