...
?>
<form action="<?php echo JRoute::_('index.php?option=com_administrations&view=districts'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th width="40%">
					<?php echo JHtml::_('grid.sort', 'COM_ADMINISTRATIONS_HEADING_DISTRICTS', 'a.nome', $listDirn, $listOrder); ?>
				</th>
			...
			<tr class="row<?php echo $i % 2; ?>">
				<td class="center">
					<?php echo JHtml::_('grid.id', $i, $item->id); ?>
                                ...
                                <td class="center">
                                    <a href="<?php echo JRoute::_('index.php?option=com_administrations&task=district.edit&id='.(int) $item->id); ?>">
