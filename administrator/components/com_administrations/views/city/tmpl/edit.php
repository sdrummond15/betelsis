...
<form action="<?php echo JRoute::_('index.php?option=com_administrations&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="city-form" class="form-validate">
<div class="width-60 fltlft">
	<fieldset class="adminform">
		<legend><?php echo empty($this->item->id) ? JText::_('COM_ADMINISTRATIONS_NEW_CITY') : JText::sprintf('COM_ADMINISTRATIONS_EDIT_CITY', $this->item->id); ?></legend>
		<ul class="adminformlist">
			...
			<?php echo $this->form->getInput('alias'); ?></li>
                        ...
                        <li><?php echo $this->form->getLabel('estado'); ?>
			<?php echo $this->form->getInput('estado'); ?></li>
